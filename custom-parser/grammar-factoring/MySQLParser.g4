...
replicationSourceOption:
    ...
    | (SOURCE_HOST_SYMBOL | MASTER_HOST_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_USER_SYMBOL | MASTER_USER_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_PASSWORD_SYMBOL | MASTER_PASSWORD_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_PORT_SYMBOL | MASTER_PORT_SYMBOL) EQUAL_OPERATOR ulong_number
    | (SOURCE_LOG_FILE_SYMBOL | MASTER_LOG_FILE_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_LOG_POS_SYMBOL | MASTER_LOG_POS_SYMBOL) EQUAL_OPERATOR ulonglong_number
    | (SOURCE_AUTO_POSITION_SYMBOL | MASTER_AUTO_POSITION_SYMBOL) EQUAL_OPERATOR ulong_number
    | (SOURCE_HEARTBEAT_PERIOD_SYMBOL | MASTER_HEARTBEAT_PERIOD_SYMBOL) EQUAL_OPERATOR ulong_number
    | (SOURCE_CONNECT_RETRY_SYMBOL | MASTER_CONNECT_RETRY_SYMBOL) EQUAL_OPERATOR ulong_number
    | (SOURCE_RETRY_COUNT_SYMBOL | MASTER_RETRY_COUNT_SYMBOL) EQUAL_OPERATOR ulong_number
    | SOURCE_CONNECTION_AUTO_FAILOVER_SYMBOL EQUAL_OPERATOR ulong_number
    | (SOURCE_DELAY_SYMBOL | MASTER_DELAY_SYMBOL) EQUAL_OPERATOR ulong_number
    | (SOURCE_COMPRESSION_ALGORITHM_SYMBOL | MASTER_COMPRESSION_ALGORITHM_SYMBOL) EQUAL_OPERATOR textStringLiteral
    | (SOURCE_ZSTD_COMPRESSION_LEVEL_SYMBOL | MASTER_ZSTD_COMPRESSION_LEVEL_SYMBOL) EQUAL_OPERATOR ulong_number
    | (SOURCE_SSL_SYMBOL | MASTER_SSL_SYMBOL) EQUAL_OPERATOR ulong_number
    | (SOURCE_SSL_CA_SYMBOL | MASTER_SSL_CA_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_SSL_CAPATH_SYMBOL | MASTER_SSL_CAPATH_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_SSL_CERT_SYMBOL | MASTER_SSL_CERT_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_SSL_CRL_SYMBOL | MASTER_SSL_CRL_SYMBOL) EQUAL_OPERATOR textLiteral
    | (SOURCE_SSL_CRLPATH_SYMBOL | MASTER_SSL_CRLPATH_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_SSL_KEY_SYMBOL | MASTER_SSL_KEY_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_SSL_CIPHER_SYMBOL | MASTER_SSL_CIPHER_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_SSL_VERIFY_SERVER_CERT_SYMBOL | MASTER_SSL_VERIFY_SERVER_CERT_SYMBOL) EQUAL_OPERATOR ulong_number
    | (SOURCE_TLS_VERSION_SYMBOL | MASTER_TLS_VERSION_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (SOURCE_TLS_CIPHERSUITES_SYMBOL | MASTER_TLS_CIPHERSUITES_SYMBOL) EQUAL_OPERATOR masterTlsCiphersuitesDef
    | (SOURCE_PUBLIC_KEY_PATH_SYMBOL | MASTER_PUBLIC_KEY_PATH_SYMBOL) EQUAL_OPERATOR textStringNoLinebreak
    | (GET_SOURCE_PUBLIC_KEY_SYMBOL | GET_MASTER_PUBLIC_KEY_SYMBOL) EQUAL_OPERATOR ulong_number
    | NETWORK_NAMESPACE_SYMBOL EQUAL_OPERATOR textStringNoLinebreak
    | IGNORE_SERVER_IDS_SYMBOL EQUAL_OPERATOR serverIdList
    | GTID_ONLY_SYMBOL EQUAL_OPERATOR ulong_number
    | PRIVILEGE_CHECKS_USER_SYMBOL EQUAL_OPERATOR privilegeCheckDef
    | REQUIRE_ROW_FORMAT_SYMBOL EQUAL_OPERATOR ulong_number
    | REQUIRE_TABLE_PRIMARY_KEY_CHECK_SYMBOL EQUAL_OPERATOR tablePrimaryKeyCheckDef
    | ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_SYMBOL EQUAL_OPERATOR ulong_number
    | RELAY_LOG_FILE_SYMBOL EQUAL_OPERATOR textStringNoLinebreak
    | RELAY_LOG_POS_SYMBOL EQUAL_OPERATOR ulong_number
;
...
alterUserTail:
    ...
    | ({serverVersion >= 80014}? alterUserList | {serverVersion < 80014}? createUserList) createUserTail
;
...
createUserTail:
    {serverVersion >= 50706}? requireClause? connectOptions? accountLockPasswordExpireOptions*
        ({serverVersion >= 80021}? (COMMENT_SYMBOL | ATTRIBUTE_SYMBOL) textString)?
    | /* empty */
;
